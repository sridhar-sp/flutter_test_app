...
class HomeWidgetState extends State<HomeWidget> {
  ...
  Column constructLogicGatesLayoutFromInput() {
    return Column(
        ...
        children: _input.logicGates.map((e) => getLogicGatesRowForLayout(e)).toList());
  }

  Widget getLogicGatesRowForLayout(List<LogicGate> layoutRow) {
    return Container(
  ...
  Widget getLogicGate(LogicGate layout) {
